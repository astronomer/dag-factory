...
def test_emit_usage_metrics_fails(mock_httpx_get, caplog):
    ...
    mock_httpx_get.assert_called_once_with("https://astronomer.gateway.scarf.sh/dag-factory/v1/0.2.0a1/2.10.1/3.11/darwin/amd64?dagfactory_version=0.2.0a1&airflow_version=2.10.1&python_version=3.11&platform_system=darwin&platform_machine=amd64&variables=%7B%27a%27%3A+1%2C+%27b%27%3A+2%7D", timeout=5.0)
...
def test_emit_usage_metrics_if_enabled_succeeds(mock_emit_usage_metrics, mock_collect_standard_usage_metrics, mock_should_emit):
